...
/**
 * Service Interface for managing {@link com.getircase.backend.domain.Order}.
 */
public interface OrderService {
    ...
    Optional<List<OrderDTO>> getOrdersByCustomerId(Long id);

    List<OrderDTO> findByOrderDatesMounth (String startDate, String endDate);
}
