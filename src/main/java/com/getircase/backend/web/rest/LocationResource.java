...
import com.getircase.backend.repository.LocationRepository;
import com.getircase.backend.service.LocationService;
...
/**
 * REST controller for managing {@link com.getircase.backend.domain.Location}.
 */
@RestController
@RequestMapping("/api")
