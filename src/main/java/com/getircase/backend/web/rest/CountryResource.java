...
import com.getircase.backend.repository.CountryRepository;
import com.getircase.backend.service.CountryService;
...
/**
 * REST controller for managing {@link com.getircase.backend.domain.Country}.
 */
@RestController
@RequestMapping("/api")
