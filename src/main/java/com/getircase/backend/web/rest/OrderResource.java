...
/**
 * REST controller for managing {@link com.getircase.backend.domain.Order}.
 */
@RestController
@RequestMapping("/api")
public class OrderResource {
    ...
    public ResponseEntity<List<OrderDTO>> getOrdersByCustomerId (@PathVariable Long id){
        log.debug("REST request to get getOrdersByCustomerId : {}", id);
        Optional<List<OrderDTO>> orderDTOList = orderService.getOrdersByCustomerId(id);
        return ResponseUtil.wrapOrNotFound(orderDTOList);
    }
