...
import com.getircase.backend.repository.CustomerRepository;
import com.getircase.backend.service.dto.CustomerDTO;
import com.getircase.backend.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    private static final Instant DEFAULT_DATE_OFBIRTH = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_OFBIRTH = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .dateOfbirth(DEFAULT_DATE_OFBIRTH)
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .dateOfbirth(UPDATED_DATE_OFBIRTH)
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getDateOfbirth()).isEqualTo(DEFAULT_DATE_OFBIRTH);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateOfbirth").value(hasItem(DEFAULT_DATE_OFBIRTH.toString())))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.dateOfbirth").value(DEFAULT_DATE_OFBIRTH.toString()))
    ...
    void putExistingCustomer() throws Exception {
        ...
        assertThat(testCustomer.getDateOfbirth()).isEqualTo(UPDATED_DATE_OFBIRTH);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.firstName(UPDATED_FIRST_NAME).dateOfbirth(UPDATED_DATE_OFBIRTH);
